import "./Blog.css";
import blogHero from "../images/printing-hero.jpg";
import {
  FaSearch,
  FaUser,
  FaShoppingCart,
     ...
     <li className="dropdown">
      ...
      <section className="blog-hero">
        ...
        <div className="blog-overlay">
          <p className="small-title">Blog</p>
      ...
      <section className="blog-container">
        ...
        <div className="blog-left">
          ...
          <div className="blog-card">
            <h2>What Are The Graduation Dress?</h2>
            <p>
              Graduation dresses are formal academic dress accessories worn
              on the graduation day to celebrate the academic convocation.
            </p>
            <a href="#">Read More</a>
          </div>

          <div className="blog-card">
            <h2>Types Of Fabric Label For Garments</h2>
            <p>
              Labels and hang tags are garment decoration & information
              accessories that play a crucial role in product packaging.
            </p>
            <a href="#">Read More</a>
          </div>

          <div className="blog-card">
            <h2>Top 10 Table Top Display Solution For Events</h2>
            <p>
              Shivani Enterprises is a customized printing company offering
              promotional display advertising solutions.
            </p>
            <a href="#">Read More</a>
          </div>
        ...
        <div className="blog-right">
          ...
          <div className="sidebar-section">
            ...
            <div className="featured-card">
              <h4>Advertising on Sun Board in Delhi</h4>
              <p>May 31, 2018</p>
            </div>
          </div>
          ...
          <div className="sidebar-section">
            ...
            <div className="featured-card">
              <h4>What are the Graduation Dress?</h4>
              <p>February 11, 2026</p>
            </div>

            <div className="featured-card">
              <h4>Types of Fabric Label For Garments</h4>
              <p>February 1, 2026</p>
            </div>
          </div>

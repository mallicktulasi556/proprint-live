...
import hero from "../images/stamp-banner.jpg";

import stamp1 from "../images/self-ink.jpg";
import stamp2 from "../images/pre-ink.jpg";
import stamp3 from "../images/polymer.jpg";
import stamp4 from "../images/signature.jpg";
import stamp5 from "../images/pocket.jpg";
import stamp6 from "../images/embossing.jpg";
import stamp7 from "../images/pen-stamp.jpg";
import stamp8 from "../images/date-stamp.jpg";
import stamp9 from "../images/fabric-stamp.jpg";
...
const stamps = [
  { name: "Self-Inking Stamps", img: stamp1, link: "/inkstamp" },
  { name: "Pre-Ink Stamp", img: stamp2 },
  { name: "Polymer Rubber Stamp", img: stamp3 },
  { name: "Signature Stamp", img: stamp4 },
  { name: "Pocket Stamp", img: stamp5 },
  { name: "Embossing Stamp", img: stamp6 },
  { name: "Pen Stamp", img: stamp7 },
  { name: "Date/Number Stamp", img: stamp8 },
  { name: "Fabric Stamp", img: stamp9 },
];
    ...
    New Arrivals <span className="dropdown-arrow">▾</span> 
     ...
     Services within hours <span className="dropdown-arrow">▾</span> 
      ...
      <section className="stamp-category">
        ...
        <p>
          Custom stamp printing provides personalized and efficient solutions
          for document marking and branding needs.
        </p>
    ...
    <div className="card-bottom">
      ...
      <section className="stamp-faq">
        ...
        <div className="faq-grid">
          ...
          <details>
            <summary>Are customizable stamp options available?</summary>
            <p>Yes we provide customized rubber stamps with text or logo.</p>
          </details>

          <details>
            <summary>What is a custom stamp?</summary>
            <p>A stamp used to mark documents, packaging, or products.</p>
          </details>

          <details>
            <summary>What information can be included?</summary>
            <p>Name, logo, company address, date, signature etc.</p>
          </details>

          <details>
            <summary>Can I include custom logos?</summary>
            <p>Yes logo stamps are very common for branding.</p>
          </details>
      ...
      <section className="stamp-content">

        <h2>Rubber Stamps for Professionals, Businesses and Craftmakers</h2>

        <p>
          Rubber stamps are used for multiple purposes such as making crisp
          and clear replication copies, avoiding manual writing errors,
          making uniform copies and product packaging.
        </p>
        ...
        <ul>
          ...
          <li>Date Changing Stamp</li>
          <li>Numbering Stamp</li>
          <li>Digital Stamping Machine</li>
        </ul>
      ...
      <section className="stamp-compare">

        <h2>Comparison Between Self Ink, Polymer & Flash Stamp</h2>

        <div className="compare-grid">

          <div className="compare-box">
            <h3>Self Ink Stamp</h3>
            <p>Fast stamping with built-in ink pad.</p>
            <p>Recommended for bulk stamping.</p>
            <p>7000+ impressions without refill.</p>
          </div>

          <div className="compare-box">
            <h3>Pre Ink Stamp</h3>
            <p>Produces sharp impressions.</p>
            <p>Uses oil-based ink.</p>
            <p>More than 10,000 impressions.</p>
          </div>

          <div className="compare-box">
            <h3>Wooden Handle Stamp</h3>
            <p>Requires separate ink pad.</p>
            <p>Low cost traditional stamp.</p>
            <p>Commonly used for offices.</p>
          </div>

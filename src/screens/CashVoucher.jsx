...
import product from "../images/voucher.jpg"; 
  ...
  return (
    <div classname="home">
      ...
      <div className="voucher-left">
        <img src={product} alt="voucher" className="main-img" />
        <img src={product} alt="thumb" className="thumb-img" />
      </div>
      ...
      <div className="voucher-right">
        ...
        <h2 className="price">₹841.00 – ₹3,412.00</h2>

        <h3>Voucher Pad Specification</h3>

        <ul className="spec">
          <li>Size: 5.5×8.5, 7×8.5</li>
          <li>Paper Gsm: 70gsm (Each book contains 100 pages)</li>
          <li>Bound Type: Glued from left side</li>
          <li>Production Turnaround: Next Day</li>
        </ul>
        ...
        <div className="option-row">
          <button
            className={size === "5.5x8.5" ? "active" : ""}
            onClick={() => setSize("5.5x8.5")}
          >
            5.5x8.5
          </button>

          <button
            className={size === "7x8.5" ? "active" : ""}
            onClick={() => setSize("7x8.5")}
          >
            7x8.5
          </button>
        </div>
      ...
      <div className="tabs">
        ...
        <h2>Cash Voucher Printing</h2>

        <p>
          Cash voucher printing is a document used for hassle-free petty cash
          accounting in organizations or commercial businesses to purchase
          goods and services internally.
        </p>

        <h3>Cash Voucher Printing Pad Size & No. of Leaf Each Pad</h3>

        <p>
          Commonly cash voucher pad size comes to A5 size and 7"x8.5", with a
          set of 100 leaves in a pad printed with a single-sided on the 70 gsm
          paper.
        </p>

        <h3>Cash Voucher Printing Online Process</h3>

        <p>
          Upload a cash voucher print-ready file online or send your printing
          content raw materials, our design team will create a cash voucher
          design and get approved before final printing free of cost.
        </p>

        <h3>Cash Voucher Printing Turnaround</h3>

        <p>
          Most of all cash voucher printing pad orders are finished within
          2-3 business days.
        </p>

        <h3>Cash Voucher Pad Price</h3>

        <p>Print petty cash voucher cost for 5 pad @ Rs.841/-</p>

            </div>
          )}

          {tab === "info" && (
            <p>Size : 5.5x8.5 , 7x8.5</p>

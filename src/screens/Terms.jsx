  ...
  Box & Packaging<span className="dropdown-arrow">▾</span> 
   ...
   Apparel <span className="dropdown-arrow">▾</span> 
      ...
      <div className="terms-container">
        ...
        <section>
          <h3>Acceptance of Terms of Usage</h3>
          <p>
            These Terms of Usage govern your access and use of this Site.
            By accessing or using this Site you agree to be bound by these
            Terms of Usage and to any additional guidelines or rules posted.
          </p>
          <p>
            PROPRINTS reserves the right to make changes to this
            Site and these Terms at any time without prior notice.
          </p>
        </section>
        ...
        <section>
          <h3>General</h3>
          <p>
            All the terms and conditions are subject to the laws of Delhi,
            India. Shivani Enterprises is not responsible for delays or
            damages resulting from machinery breakdown, acts of God,
        ...
        <section>
          <h3>Reservations</h3>
          <p>
            All orders are subject to acceptance by Shivani Enterprises.
            We reserve the right to reject any order at any time.
          </p>
        </section>
        ...
        <section>
          <h3>Returns</h3>
          <p>
            Due to the nature of customized products, no returns can be made
            once the order is processed or shipped.
            Claims must be made within 2 business days.
          </p>
        </section>
        ...
        <section>
          <h3>Credit Card</h3>
          <p>
            If the Buyer’s credit card is declined, Shivani Enterprises will
        ...
        <section>
          <h3>Warranty</h3>
          <p>
            Shivani Enterprises does not guarantee replacement of defective
            products unless verified by our quality team.
          </p>
        </section>
        ...
        <section>
          <h3>Shipping</h3>
          <p>
            Shivani Enterprises will arrange shipping with a reputed carrier.
        ...
        <section>
          ...
          <p>
            Shivani Enterprises will not be liable for incidental or
        ...
        <section>
          ...
          <p>
            No refund will be issued once the order is processed or shipped.
          </p>
        </section>
</div>
      {/* ================= FOOTER ================= */}

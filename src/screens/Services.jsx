...
import hero from "../images/same-day-banner.jpg";

import standardbusinesscard from "../images/standardbusinesscard.jpg";
...
import fabric from "../images/fabricbanner.jpg";
...
import paperid from "../images/paperid.jpg";
import lamination from "../images/lamination.jpg";
...
const sameDay = [
{title:"Standard Business Card", img:standardbusinesscard},
...
{title:"Bookmark", img:bookmark},
{title:"Cap", img:cap},
{title:"T-shirt", img:tshirt},
{title:"Sheet Stickers", img:stickers},
{title:"Banner", img:bannerImg},
{title:"Fabric Banner", img:fabric},
{title:"Sunboard", img:sunboard},
{title:"Menu", img:menu},
{title:"Poster", img:poster}
];
const nightServices = [
{title:"Document", img:document},
{title:"Paper ID Card", img:paperid},
{title:"Lamination", img:lamination},
{title:"Mug", img:mugimg},
{title:"School/College", img:school},
{title:"Spiral Binding", img:spiral},
{title:"Self Ink Stamp", img:stamp}
];
return(
...
Require printing products urgently? Place your order by 7 p.m.
</p>
...
<h2>Late Night Printing Services</h2>

<p className="subtitle">
Late-night printing services available like document, stamp,
mug, scanning and more.
</p>

<div className="grid">

{nightServices.map((item,index)=>(
<div className="card" key={index}>
<img src={item.img}/>
<div className="card-bottom">
<h3>{item.title}</h3>
...
<h2>Our Services Within Hour</h2>

<p>
We provide more than 50 customized printing products within hours
including document printing, marketing materials and gift items.
</p>

<h3>Our Same Day Printing Services For Delhi & NCR</h3>

<p>
Variety of products can be customized within hours including
business cards, identity cards, banners and posters.
</p>

<h3>Late Night Printing Product</h3>

<p>
Urgent document printing, identity cards, spiral binding,
t-shirt printing and lamination available overnight.
</p>
...
<details>
<summary>What are late-night printing products?</summary>
<p>Printing services available overnight like document, lamination and ID cards.</p>
</details>

<details>
<summary>Why would I need late-night printing services?</summary>
<p>For urgent work or last minute printing requirements.</p>
</details>

<details>
<summary>What types of documents can I print late at night?</summary>
<p>Reports, assignments, identity cards, certificates etc.</p>
</details>

<details>
<summary>Are late-night printing services expensive?</summary>
<p>Prices are similar with minimal night service charges.</p>
</details>

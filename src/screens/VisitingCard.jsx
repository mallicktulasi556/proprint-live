...
import hero from "../images/visiting-card-banner.jpg";
...
const popularCards = [
  { img: card1, title: "Standard Business Card", link: "/standardcard" },
  { img: card2, title: "Laminated Business Card" },
  { img: card3, title: "Textured Business Card"},
  { img: card4, title: "Metallic Business Card" },
  { img: card5, title: "Round Corner Business Card"},
  { img: card6, title: "Cheap Business Card" },
  { img: card7, title: "Non-Tearable Business Card" },
  { img: card8, title: "Spot UV Business Card" }
];

const premiumCards = [
  { img: card1, title: "Spot UV Business Card" },
  { img: card2, title: "Embossed Business Card" },
  { img: card3, title: "Foil Stamped Business Card" },
  { img: card4, title: "Eco-Friendly Business Card" },
  { img: card5, title: "Transparent Business Card" },
  { img: card6, title: "Custom Shape Business Card" },
  { img: card7, title: "PVC Business Card" },
];

const specializedCards = [
  { img: card1, title: "QR Business Card" },
  { img: card2, title: "PVC NFC Business Card" },
  { img: card3, title: "Metal NFC Business Card" },
];

const faqs = [
  {
    q: "What are the different printing options for visiting cards?",
    a: "We provide digital printing, offset printing, foil printing, UV printing and embossing."
  },
  {
    q: "What is the recommended paper weight for visiting cards?",
    a: "Most businesses choose 300–350 GSM premium card stock."
  },
  {
    q: "What is the difference between matte and glossy finish?",
    a: "Matte gives smooth elegant look while glossy gives shiny vibrant colors."
  },
  {
    q: "Can I print double-sided visiting cards?",
    a: "Yes, we offer both single side and double side printing."
  },
  {
    q: "What is the turnaround time for visiting card printing?",
    a: "Usually same day or next day depending on quantity."
  }
];
const navigate = useNavigate();
    ...
    New Arrivals <span className="dropdown-arrow">▾</span> 
     ...
     Services within hours <span className="dropdown-arrow">▾</span> 
      ...
      <section className="intro">
        <h2>Visiting Cards Online</h2>
        <p>
          Looking for visiting card printing near me? Shivani Enterprises offers
          urgent, high-quality business card printing with glossy, matte,
          laminated, and premium options.
        </p>
      </section>

      {/* POPULAR */}
      <section className="cards-section">
        <h2>Most Popular Business Cards</h2>
  ...
  >
    ...
    <h3>{card.title}</h3>
      ...
      {/* SPECIALIZED */}
      <section className="cards-section">
        <h2>Specialized Business Cards</h2>

        <div className="card-grid">
          {specializedCards.map((card, i) => (
            <div className="card-box" key={i}>
              <img src={card.img} alt="" />
              <h3>{card.title}</h3>
            </div>
      ...
      <section className="content">
        ...
        <p>
          Visiting cards are the identity of your organization and your first
          introduction to customers. We offer a wide range of premium business
          card printing solutions.
        </p>

        <h3>Types of Visiting Cards We Offer</h3>

        <ul>
          <li>Cheap Business Cards</li>
          <li>Laminated Business Cards</li>
          <li>Spot UV Printed Business Cards</li>
          <li>Foil Printed Cards</li>
          <li>Embossed Cards</li>
          <li>QR Business Cards</li>

    ...
    <div className="help-page">
      ...
      <div className="help-info">
        ...
        <div className="info-box">
          ...
          <h3>Address</h3>
          <p>first floor, Mounika Towers</p>
          <p><b>2-32, Kavuri Hills, Madhapur</b></p>
        ...
        <div className="info-box">
          ...
          <h3>Contact</h3>
          <p>Mobile: <b>+91 9211253015</b></p>
          <p>Landline: 011 46091624</p>
          <p>E-mail: suresh_shivanient@yahoo.com</p>
        </div>
      ...
      <div className="faq-section">
        ...
        <details>
          ...
          <p>You can place an order through our website or by contacting our support team.</p>
        </details>

        <details>
          <summary>Can I place multiple orders for a single product?</summary>
          <p>Yes, you can order multiple quantities of the same product.</p>
        </details>

        <details>
          <summary>Will I get a design proof / preview before placing the order?</summary>
          <p>Yes, we provide a preview before final printing.</p>
        </details>

        <details>
          <summary>Can I share multiple images / designs in an order?</summary>
          <p>Yes, you can upload multiple designs depending on the product.</p>
        </details>

        <details>
          <summary>Should I place an order only via online?</summary>
          <p>You can also place an order by contacting us directly.</p>
        </details>

        <h2>Products</h2>

        <details>
          <summary>What if I can't find the product I'm looking for?</summary>
          <p>Please contact our team and we will help you.</p>
        </details>
        ...
        <details>
          ...
          <p>We accept UPI, debit cards, credit cards and net banking.</p>
        </details>

        <details>
          <summary>Payment made but order not placed?</summary>
          <p>Please contact our support team with transaction details.</p>
        </details>

        <details>
          <summary>What if you are unable to make payment online?</summary>
          <p>You can contact us and we will assist you.</p>
        </details>

...
import receiptBook from "../images/receiptbook.jpg";
...
import staple from "../images/staple.jpg";
...
const essentials = [
{title:"Business Card", img:businessCard},
{title:"Envelope", img:envelope},
{title:"Letterhead", img:letterhead},
{title:"Bill Book", img:billBook},
{title:"Receipt Book", img:receiptBook},
{title:"Cash Voucher", img:cashVoucher},
{title:"ID Card", img:idCard},
{title:"Stamp", img:stamp}
];

const cards = [
{title:"Wedding Card", img:wedding},
{title:"Engagement Card", img:engagement},
{title:"Post Card", img:postcard},
{title:"Business Invitation", img:invitation},
{title:"Event Ticket", img:ticket},
{title:"Greeting Card", img:greeting},
{title:"Birthday Invitation", img:birthday},
{title:"Thank You Card", img:thankyou}
];

const notebook = [
{title:"Staple Notebook", img:staple},
{title:"Wire-o Notebook", img:wire},
{title:"Perfect Bound", img:perfect},
{title:"Hard Bound", img:hard}
];
...
<div>
<details>
<summary>What are stationery printing items?</summary>
<p>Stationery items include business cards, envelopes, letterheads etc.</p>
</details>

<details>
<summary>What types of stationery can be printed?</summary>
<p>Business cards, vouchers, invoices, ID cards and many more.</p>
</details>

<details>
<summary>What is the purpose of custom stationery?</summary>
<p>Custom stationery builds brand identity.</p>
</details>
...
<div>
<details>
<summary>What information should be in a letterhead?</summary>
<p>Company logo, address, contact details.</p>
</details>

<details>
<summary>How to design a business card?</summary>
<p>Include name, contact info and logo.</p>
</details>

<details>
<summary>What file formats are supported?</summary>
<p>PDF, PNG, AI, PSD are supported.</p>
</details>
...
<h2>Customized Office Stationery Printing in Hyderabad</h2>

<p>
Get printed your Business Customized Stationery Online and put your Brand
Identity in front of your business prospects with competitive prices and
...
<p>
A customized business card represents your brand and company identity.
Choose from premium materials and finishing options.
</p>

<h3>Office Supply</h3>

<p>
Printed office supplies help to run your business smoothly and maintain
accounting accuracy.
</p>
...
<p>
High quality logo printed lanyards with ID cards provide professional identity
to employees.
</p>

<h3>Ink and Stamps</h3>

<p>
Rubber stamps and ink pads are essential tools for business documentation.
</p>

<h3>Cards & Invitation</h3>

<p>
Wedding cards, invitation cards, event tickets and greeting cards printing.
</p>

<h3>Notebook</h3>

<p>
Customized notebooks for business, school and events with different binding
options.
</p>
